...
**[FastMD 1.3.0 — latest release](https://github.com/beanbo/FastMD/releases/latest):**
...
2. Or `FastMD-1.3.0-win-x64.zip` — unpack it anywhere and run `FastMD.exe`; to make `.md` files open on a double click, pick "Open .md files with FastMD…" from the context menu and confirm the choice in Settings.
