...
enum Row { ROW_THEME, ROW_FONT, ROW_SIZE, ROW_COLUMN, ROW_WRAP, ROW_SMOOTH, ROW_LANG, ROW_EDITOR, ROW_ASSOC, ROW_COUNT };
...
const wchar_t* Label(int row) {
    static const StrId ids[ROW_COUNT] = {S_SET_THEME, S_SET_FONT, S_SET_SIZE, S_SET_COLUMN, S_SET_WRAP, S_SET_SMOOTH,
                                         S_SET_LANGUAGE, S_SET_EDITOR, S_SET_ASSOC};
    return Tr(ids[row]);
}
