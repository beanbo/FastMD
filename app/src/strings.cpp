...
const Pair kStr[] = {
    ...
    // Phase 3b: source popups, the link and code-language popovers, the bubble, pictures, the edit menu
    {L"Формула", L"Formula"},
    {L"Формула (отдельной строкой)", L"Formula (own line)"},
    {L"Диаграмма Mermaid", L"Mermaid diagram"},
    {L"HTML", L"HTML"},
    ...
    {L"Строка --- закончит блок свойств", L"A --- line would end the properties block"},
    {L"Ошибка в формуле", L"Formula error"},
    {L"Ошибка в диаграмме", L"Diagram error"},
    {L"Адрес задан определением [%s]", L"Defined by [%s]"},
    {L"Готово", L"Done"},
    {L"Убрать ссылку", L"Remove link"},
    {L"Адрес задан определением [%s] — изменение затронет все ссылки на него",
     L"Defined by [%s] — changing it changes every link that uses it"},
    {L"Язык кода", L"Code language"},
    {L"Окно ввода недоступно — источник правится прямо в тексте", L"The input box is unavailable — the source is edited in place"},
    {L"Вставить можно только картинки", L"Only pictures can be pasted"},
    {L"Изменить", L"Edit"},
    {L"Убрать", L"Remove"},
    {L"Открыть", L"Open"},
