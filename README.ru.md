...
**[FastMD 1.3.0 — последний релиз](https://github.com/beanbo/FastMD/releases/latest):**
...
2. Или `FastMD-1.3.0-win-x64.zip` — распакуйте куда угодно и запустите `FastMD.exe`; чтобы `.md` открывались двойным кликом, выберите в контекстном меню «Открывать .md в FastMD…» и подтвердите выбор в «Параметрах».
